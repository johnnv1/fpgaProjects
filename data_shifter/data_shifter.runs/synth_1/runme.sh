...
HD_PWD='C:/Users/yakuza/Desktop/projetosCI/vivadoProjects/data_shifter/data_shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_shifter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_shifter.tcl
