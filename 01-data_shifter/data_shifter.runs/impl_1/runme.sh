...
HD_PWD='C:/Users/yakuza/Desktop/projetosCI/vivadoProjects/data_shifter/data_shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data_shifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data_shifter.tcl -notrace
