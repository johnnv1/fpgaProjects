...
#
# serial_dump.tcl: Tcl script for re-creating project 'serial'
#
# Generated by Vivado on Tue Oct 01 11:55:39 -0300 2019
...
#
# 1. This project restoration tcl script (serial_dump.tcl) that was generated.
#
...
set script_file "serial_dump.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/vivado_serial"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/sources/serial.vhd"] \
 [file normalize "${origin_dir}/sources/counter.vhd"] \
 [file normalize "${origin_dir}/sources/data_shifter.vhd"] \
]
...
set file "$origin_dir/sources/serial.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/sources/data_shifter.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "serial" -objects $obj
...
set file "[file normalize "$origin_dir/nexys4DDR.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/nexys4DDR.xdc"
set file [file normalize $file]
