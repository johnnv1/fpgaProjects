...
synth_design -top chronometer -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef chronometer.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file chronometer_utilization_synth.rpt -pb chronometer_utilization_synth.pb"
