...
HD_PWD='C:/Users/yakuza/Desktop/projetosCI/vivadoProjects/fpgaProjects/chronometer/chronometer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chronometer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chronometer.tcl
