...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { leds_4bits_tri_io[0] }]; #IO_L23P_T3_35 Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { leds_4bits_tri_io[1] }]; #IO_L23N_T3_35 Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { leds_4bits_tri_io[2] }]; #IO_0_35=Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { leds_4bits_tri_io[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD TMDS_33 } [get_ports TMDS_clk_n]; #IO_L13N_T2_MRCC_35 Sch=HDMI_CLK_N
set_property -dict { PACKAGE_PIN H16   IOSTANDARD TMDS_33 } [get_ports TMDS_clk_p]; #IO_L13P_T2_MRCC_35 Sch=HDMI_CLK_P
set_property -dict { PACKAGE_PIN D20   IOSTANDARD TMDS_33 } [get_ports { TMDS_data_n[0] }]; #IO_L4N_T0_35 Sch=HDMI_D0_N
set_property -dict { PACKAGE_PIN D19   IOSTANDARD TMDS_33 } [get_ports { TMDS_data_p[0] }]; #IO_L4P_T0_35 Sch=HDMI_D0_P
set_property -dict { PACKAGE_PIN B20   IOSTANDARD TMDS_33 } [get_ports { TMDS_data_n[1] }]; #IO_L1N_T0_AD0N_35 Sch=HDMI_D1_N
set_property -dict { PACKAGE_PIN C20   IOSTANDARD TMDS_33 } [get_ports { TMDS_data_p[1] }]; #IO_L1P_T0_AD0P_35 Sch=HDMI_D1_P
...
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports hdmi_hpd_tri_o]; #IO_L5P_T0_AD9P_35 Sch=HDMI_HPD
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports HDMI_OEN]; #IO_L6N_T0_VREF_35 Sch=HDMI_OUT_EN
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports DDC_scl_io]; #IO_L16P_T2_35 Sch=HDMI_SCL
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports DDC_sda_io]; #IO_L16N_T2_35 Sch=HDMI_SDA
