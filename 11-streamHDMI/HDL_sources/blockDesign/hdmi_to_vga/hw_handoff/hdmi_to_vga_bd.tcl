...
################################################################
# This is a generated script based on design: hdmi_to_vga
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: proce_sys7_0_axi_periph, and set properties
  set proce_sys7_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 proce_sys7_0_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {8} \
 ] $proce_sys7_0_axi_periph

  # Create instance: proce_sys_rst_100M, and set properties
  set proce_sys_rst_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proce_sys_rst_100M ]
  set_property -dict [ list \
   CONFIG.C_AUX_RESET_HIGH {0} \
 ] $proce_sys_rst_100M

  # Create instance: proce_sys_rst_150M, and set properties
  set proce_sys_rst_150M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proce_sys_rst_150M ]

  # Create instance: proce_sys_rst_pxCLK, and set properties
  set proce_sys_rst_pxCLK [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proce_sys_rst_pxCLK ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins proce_sys7_0_axi_periph/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net TMDS_1 [get_bd_intf_ports TMDS] [get_bd_intf_pins dvi2rgb_0/TMDS]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports hdmi_hpd] [get_bd_intf_pins axi_gpio_video/GPIO]
  ...
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_gpio_led/S_AXI] [get_bd_intf_pins proce_sys7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_btn/S_AXI] [get_bd_intf_pins proce_sys7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_SW/S_AXI] [get_bd_intf_pins proce_sys7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M03_AXI [get_bd_intf_pins proce_sys7_0_axi_periph/M03_AXI] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_dynclk_0/s00_axi] [get_bd_intf_pins proce_sys7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M05_AXI [get_bd_intf_pins axi_vdma_0/S_AXI_LITE] [get_bd_intf_pins proce_sys7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M06_AXI [get_bd_intf_pins proce_sys7_0_axi_periph/M06_AXI] [get_bd_intf_pins v_tc_1/ctrl]
  connect_bd_intf_net -intf_net proce_sys7_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_video/S_AXI] [get_bd_intf_pins proce_sys7_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins proce_sys_rst_pxCLK/slowest_sync_clk] [get_bd_pins v_tc_1/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net dvi2rgb_0_aPixelClkLckd [get_bd_pins axi_gpio_video/gpio2_io_i] [get_bd_pins dvi2rgb_0/aPixelClkLckd] [get_bd_pins proce_sys_rst_pxCLK/aux_reset_in]
  connect_bd_net -net proce_sys_rst_100M_interconnect_aresetn [get_bd_pins proce_sys7_0_axi_periph/ARESETN] [get_bd_pins proce_sys_rst_100M/interconnect_aresetn]
  connect_bd_net -net proce_sys_rst_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_SW/s_axi_aresetn] [get_bd_pins axi_gpio_btn/s_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins dvi2rgb_0/aRst_n] [get_bd_pins proce_sys7_0_axi_periph/M00_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M01_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M02_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M03_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M04_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M05_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M06_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/M07_ARESETN] [get_bd_pins proce_sys7_0_axi_periph/S00_ARESETN] [get_bd_pins proce_sys_rst_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn] [get_bd_pins v_tc_1/s_axi_aresetn]
  connect_bd_net -net proce_sys_rst_150M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins proce_sys_rst_150M/interconnect_aresetn]
  connect_bd_net -net proce_sys_rst_150M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins proce_sys_rst_150M/peripheral_aresetn]
  connect_bd_net -net proce_sys_rst_pxCLK_peripheral_aresetn [get_bd_pins proce_sys_rst_pxCLK/peripheral_aresetn] [get_bd_pins v_tc_1/resetn]
  connect_bd_net -net proce_sys_rst_pxCLK_peripheral_reset [get_bd_pins proce_sys_rst_pxCLK/peripheral_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins axi_gpio_SW/s_axi_aclk] [get_bd_pins axi_gpio_btn/s_axi_aclk] [get_bd_pins axi_gpio_led/s_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins proce_sys7_0_axi_periph/ACLK] [get_bd_pins proce_sys7_0_axi_periph/M00_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M01_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M02_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M03_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M04_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M05_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M06_ACLK] [get_bd_pins proce_sys7_0_axi_periph/M07_ACLK] [get_bd_pins proce_sys7_0_axi_periph/S00_ACLK] [get_bd_pins proce_sys_rst_100M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins v_tc_1/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins proce_sys_rst_150M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proce_sys_rst_100M/ext_reset_in] [get_bd_pins proce_sys_rst_150M/ext_reset_in] [get_bd_pins proce_sys_rst_pxCLK/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_SW/S_AXI/Reg] SEG_axi_gpio_SW_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_led/S_AXI/Reg] SEG_axi_gpio_led_Reg
