...
--Command     : generate_target hdmi_to_vga_wrapper.bd
--Design      : hdmi_to_vga_wrapper
...
end hdmi_to_vga_wrapper;

architecture STRUCTURE of hdmi_to_vga_wrapper is
  component hdmi_to_vga is
  port (
    sws_4bits_tri_i : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
hdmi_to_vga_i: component hdmi_to_vga
     port map (
      DDC_scl_i => DDC_scl_i,
      DDC_scl_o => DDC_scl_o,
      DDC_scl_t => DDC_scl_t,
