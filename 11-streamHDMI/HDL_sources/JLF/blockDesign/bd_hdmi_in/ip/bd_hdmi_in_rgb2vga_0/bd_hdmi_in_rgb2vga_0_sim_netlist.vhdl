...
-- Command     : write_vhdl -force -mode funcsim -rename_top bd_hdmi_in_rgb2vga_0 -prefix
--               bd_hdmi_in_rgb2vga_0_ hdmi_rgb2vga_0_0_sim_netlist.vhdl
...
entity bd_hdmi_in_rgb2vga_0_rgb2vga is
  port (
...
end bd_hdmi_in_rgb2vga_0_rgb2vga;

architecture STRUCTURE of bd_hdmi_in_rgb2vga_0_rgb2vga is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_hdmi_in_rgb2vga_0 is
  port (
  ...
  attribute NotValidForBitStream of bd_hdmi_in_rgb2vga_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_hdmi_in_rgb2vga_0 : entity is "hdmi_rgb2vga_0_0,rgb2vga,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of bd_hdmi_in_rgb2vga_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of bd_hdmi_in_rgb2vga_0 : entity is "rgb2vga,Vivado 2018.3";
end bd_hdmi_in_rgb2vga_0;

architecture STRUCTURE of bd_hdmi_in_rgb2vga_0 is
...
begin
U0: entity work.bd_hdmi_in_rgb2vga_0_rgb2vga
     port map (
      PixelClk => PixelClk,
