...
--Date        : Tue Dec 10 16:46:07 2019
--Host        : cabernet running 64-bit CentOS release 6.10 (Final)
--Command     : generate_target bd_hdmi_in_wrapper.bd
--Design      : bd_hdmi_in_wrapper
...
end bd_hdmi_in_wrapper;

architecture STRUCTURE of bd_hdmi_in_wrapper is
  component bd_hdmi_in is
  port (
    hdmi_out_enable : out STD_LOGIC_VECTOR ( 0 to 0 );
    vga_r : out STD_LOGIC_VECTOR ( 4 downto 0 );
    vga_g : out STD_LOGIC_VECTOR ( 5 downto 0 );
...
begin
bd_hdmi_in_i: component bd_hdmi_in
     port map (
      ...
      hdmi_out_enable(0) => hdmi_out_enable(0),
